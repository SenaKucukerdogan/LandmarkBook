...
//  LandmarkBook
//
//  Created by Sena Küçükerdoğan on 13.04.2022.
//

import UIKit

class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {  // 1. adım
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Landmark Book"    //diyerek projemize başlık atarız
    }
    ...
    // 3. adım cellForRowAt ve numberOfRowsInSection bu iki fonksiyon
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) { //seçilince
